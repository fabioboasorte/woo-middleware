...
class PagadorClient {
  ...
  async createSale(request, credentials = null) {
    ...
    if (
      (typeof this.credentials.MerchantKey === "undefined" ||
        this.credentials.MerchantKey === null) &&
      (typeof credentials.MerchantKey === "undefined" ||
        credentials.MerchantKey === null)
    )
    ...
    await axios
      .post(`${this.url}v2/sales`, request, { headers })
      .then((res) => {
  ...
  async capture(request, credentials = null) {
    ...
    await axios
      .put(
        `${this.url}v2/sales/${request.PaymentId}/capture?amount=${
          typeof request.Amount === "undefined" || request.Amount === null
            ? 0
            : request.Amount
        }`,
        {},
  ...
  async void(request, credentials = null) {
    ...
    await axios
      .put(
        `${this.url}v2/sales/${request.PaymentId}/void`,
  ...
  async getOrderById(paymentId, credentials = null) {
    ...
    await axios
      .get(`${this.urlQuery}v2/sales/${paymentId}/`, { headers })
      .then((res) => {
        response = { httpStatus: res.status, ...res.data };
      })
      .catch((error) => {
  ...
  async changeRecurrencyCustomer(
    recurrentPaymentId,
    customer,
    credentials = null
  ) {
    if (
      typeof recurrentPaymentId === "undefined" ||
    ...
    await axios
      .put(
        `${this.urlQuery}v2/recurrentpayment/${recurrentPaymentId}/customer`,
        customer,
        { headers }
      )
      .then((res) => {
  ...
  async changeRecurrencyEndDate(
    ...
    await axios
      .put(
        `${this.url}v2/recurrentpayment/${recurrentPaymentId}/enddate`,
  ...
  async changeRecurrencyInterval(
    recurrentPaymentId,
    interval,
    credentials = null
  ) {
    ...
    await axios
      .put(
        `${this.url}v2/recurrentpayment/${recurrentPaymentId}/interval`,
        interval,
        { headers }
      )
      .then((res) => {
  ...
  async changeRecurrencyDay(recurrentPaymentId, day, credentials = null) {
    ...
    await axios
      .put(
        `${this.url}v2/recurrentpayment/${recurrentPaymentId}/recurrencyDay`,
        day,
        { headers }
      )
      .then((res) => {
  ...
  async changeRecurrencyAmount(recurrentPaymentId, amount, credentials = null) {
    ...
    await axios
      .put(
        `${this.url}v2/recurrentpayment/${recurrentPaymentId}/amount`,
        amount,
        { headers }
      )
      .then((res) => {
  ...
  async changeRecurrencyNextPaymentDate(
    recurrentPaymentId,
    nextPaymentDate,
    credentials = null
  ) {
    ...
    await axios
      .put(
        `${this.url}v2/recurrentpayment/${recurrentPaymentId}/nextPaymentDate`,
        JSON.stringify(nextPaymentDate),
        { headers }
      )
      .then((res) => {
        response = { httpStatus: res.status };
  ...
  async changeRecurrencyPayment(
    ...
    await axios
      .put(
        `${this.url}v2/recurrentpayment/${recurrentPaymentId}/payment`,
        payment,
        { headers }
      )
      .then((res) => {
  ...
  async deactivateRecurrency(recurrentPaymentId, credentials = null) {
    ...
    await axios
      .put(
        `${this.url}v2/recurrentpayment/${recurrentPaymentId}/deactivate`,
        {},
        { headers }
      )
      .then((res) => {
  ...
  async reactivateRecurrency(recurrentPaymentId, credentials = null) {
    ...
    await axios
      .put(
        `${this.url}v2/recurrentpayment/${recurrentPaymentId}/reactivate`,
        {},
        { headers }
      )
      .then((res) => {
  ...
  async getRecurrency(recurrentPaymentId, credentials = null) {
    ...
    await axios
      .get(`${this.urlQuery}v2/recurrentpayment/${recurrentPaymentId}`, {
        headers,
      })
      .then((res) => {
        response = { httpStatus: res.status };
